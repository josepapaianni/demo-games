...
AppManager.prototype = {
  ...
  welcome: function () {
    ...
    this.welcomePopup.clickedStart.add(this.initializeGameContext, this);
  },

  //when the user click start game
  initializeGameContext: function () {
    // Call the proxy to get game info, and then start the game (startWinner)
  ...
  loadModules: function () {
    ...
    //Hud Module
    this.hud = new Hud(this.game, this.gameManager, this, gameConfig, null, '0x8acafb');
  ...
  gameEnd: function (score) {
    ...
    this.proxyManager.gameEnd(score);
  }
